...
public class HW2_sample_3 {

	public static void main(String[] args) throws Exception{


		AWSCredentials credentials = new PropertiesCredentials(
				HW2_sample_3.class.getResourceAsStream("AwsCredentials.properties"));
		...
		String instanceId = "i-a76ea2db"; //put your own instance id to test this code.
